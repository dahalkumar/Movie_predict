...
#InitializedModelDetail namedtuple has model_serial_number ,model object,parameter that we get after hypertuned and model_name 
InitializedModelDetail = namedtuple("InitializedModelDetail",
                                    ["model_serial_number", "model", "param_grid_search", "model_name"])
#namedTuple of GridSearchCV
...
class ModelFactory:
    def __init__(self, model_config_path: str = None,):
        try:
            #read the model.yaml file since model factory is not dependent on other function we create yaml reader inside it
            self.config: dict = ModelFactory.read_params(model_config_path)
            
            #for import GridSearchCV module info 
            self.grid_search_cv_module: str = self.config[GRID_SEARCH_KEY][MODULE_KEY]
            
            #for import GridSearchCV params class 
            self.grid_search_class_name: str = self.config[GRID_SEARCH_KEY][CLASS_KEY]
            
            #for import GridSearchCV params
    ...
    def class_for_name(module_name:str, class_name:str):
        ...
        try:
            ...
            #module is sklean.linear_module  class_name = LinearRegression
    ...
    def execute_grid_search_operation(self, initialized_model: InitializedModelDetail, input_feature,
        ...
        try:
           ...
           # importing GridSearchCV class and instantiating it
            ...
            #add the property to grid_search_cv using setattr
    ...
    def get_initialized_model_list(self) -> List[InitializedModelDetail]:
        ...
        i.e namedtuple will be returned which contains the tuples of initialized models
        model_serial_number", "model", "param_grid_search", "model_name"
        """
        try:
    ...
    def get_best_model(self, X, y,base_accuracy=0.6) -> BestModel:
        try:
            ...
            #get the best model list applying the grid search best model list which will take model list target feature and independent feature
