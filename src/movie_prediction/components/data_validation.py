...
from movie_prediction.entity.config_entity import DataValidationConfig
from movie_prediction.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact
import os,sys
import pandas  as pd
